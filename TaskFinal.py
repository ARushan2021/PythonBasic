...
class Seach_selenide(unittest.TestCase):
    ...
    def test_Seach_selenide(self):
        ...
        first_link = self.drv.find_element(By.XPATH, '//*[@id="rso"]/div[1]/div/div/div/div/div/div/div/div[1]/a/h3')
        first_link.click()
        ...
        assert "selenide.org" in first_image

        # 6.Вернуться в раздел поиска Все
        self.drv.back()

        # 7.Проверяем, что первый результат такой же, как и на шаге 3.
        first_link2 = self.drv.find_element(By.XPATH, '//*[@id="rso"]/div[1]/div/div/div/div/div/div/div/div[1]/a/h3')
        first_link2.click()
